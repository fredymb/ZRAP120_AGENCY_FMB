CLASS zgenerate_agency_data_FMB DEFINITION
   PUBLIC
   FINAL
   CREATE PUBLIC .
...
CLASS zgenerate_agency_data_FMB IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA: agencies  TYPE TABLE OF zagencyFMB.

*     DELETE FROM zagencyFMB_e.
*     "EXIT.

    "delete existing data
    DELETE FROM zagencyFMB.
    DELETE FROM zagencyFMB_d.
...
*    insert the new table entries
    INSERT zagencyFMB FROM TABLE @agencies.
